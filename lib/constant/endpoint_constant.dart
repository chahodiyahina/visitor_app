class ApiEndPoint {
  // Live
  // static String baseUrl = "https://api.assignmentgpt.ai/v1/";

  // locale
  // static String baseUrl = "https://gatepass.fin-wall.com/api/";
  static String baseUrl = "https://api.fin-wall.com/api/";

  static String login = "login";
  static String getHomeData = "dashboard-data-get";
  static String visitorDataGet = "visitor-data-get";
  static String getVisitorDataOnMobile = "get-visitor-data";
  static String searchHostName = "search-host-name";
  static String searchSiteName = "search-site-name";
  ...
  static String getVehicleData = "get-vehicle-data";
  static String createVehicleData = "create-vehicle-data";
